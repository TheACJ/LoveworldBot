-- BEGIN DESTRUCTIVE SCRIPT - Service Role Schema
-- WARNING: This will DROP data and objects. BACKUP before running.
-- This schema uses ONLY Service Role access - no complex RLS policies

-- 0) Helper: remove statement timeout for long ops
...
-- 3) Recreate tables and objects - SIMPLIFIED SERVICE ROLE APPROACH
...
-- 6) NO RLS - Service Role Only Approach
...
-- 11) Enable realtime for service role access
